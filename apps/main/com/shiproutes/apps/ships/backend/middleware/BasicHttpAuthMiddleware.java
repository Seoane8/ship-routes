...
import com.shiproutes.ships.auth.application.authenticate.AuthenticateUserCommand;
import com.shiproutes.ships.auth.domain.InvalidAuthCredentials;
import com.shiproutes.ships.auth.domain.InvalidAuthUsername;
...
public final class BasicHttpAuthMiddleware implements Filter {
    ...
    private void askForCredentials(ServletResponse response) {
        ...
        httpServletResponse.setHeader("WWW-Authenticate", "Basic realm=\"Ship Routes\"");
    }
}
