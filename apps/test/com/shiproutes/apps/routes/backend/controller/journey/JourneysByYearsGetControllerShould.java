...
class JourneysByYearsGetControllerShould extends RoutesApplicationTestCase {
    ...
    @Test
    void return_existent_journeys_by_year() throws Exception {
        ...
        assertResponse("/journeys/years", 200, "[" +
            "{" +
