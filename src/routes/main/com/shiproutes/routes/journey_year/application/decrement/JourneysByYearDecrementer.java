...
@Service
public class JourneysByYearDecrementer {

    private final JourneysByYearRepository repository;
    private final UuidGenerator uuidGenerator;
    private final QueryBus queryBus;

    public JourneysByYearDecrementer(JourneysByYearRepository repository, UuidGenerator uuidGenerator, QueryBus queryBus) {
        this.repository = repository;
        this.uuidGenerator = uuidGenerator;
        this.queryBus = queryBus;
    }

    public void decrement(PortId originPort, PortId destinationPort, Teus teus, Year year) {
        ...
        journeysByYear.decrementJourneys();
        journeysByYear.decrementTeus(teus);
